...
public class Data {
	...
	private String start_station_name;// 列车起始站
	private String end_station_telecode;
	private String end_station_name;// 列车终点站
	private String from_station_telecode;
	private String from_station_name;// 查询起始站
	private String to_station_telecode;
	private String to_station_name;// 查询终点站
	...
	public String toString() {
		return station_train_code + "\t" + from_station_name + "\t" + to_station_name + "\t" + start_time + "\t"
				+ arrive_time + "\t" + lishi + "\t" + swz_num + "\t" + tz_num + "\t" + zy_num + "\t" + ze_num 
				+ "\t" + gr_num + "\t" + rw_num + "\t" + yw_num + "\t" + rz_num + "\t" + yz_num + "\t" + wz_num
				+ "\t" + qt_num + "\n";
	}
}
